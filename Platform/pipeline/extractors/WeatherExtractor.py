...
# =============================================================================
# TESTING CODE - Run this file directly to test the extractor
# =============================================================================

if __name__ == "__main__":
    """
    Test the WeatherExtractor independently.
    
    To run:
        python WeatherExtractor.py
    
    Make sure your .env file has:
        WEATHER_API_URL=https://api.weather.gov
        WEATHER_USER_AGENT=(YourApp, your-email@gatech.edu)
    """
    import os
    ...
    if not user_agent:
        print("ERROR: WEATHER_USER_AGENT not found in .env file")
        print("Add: WEATHER_USER_AGENT=(StingerDelay, your-email@gatech.edu)")
        exit(1)
    
    try:
        print("="*72)
        print("Testing WeatherExtractor")
        print("="*72)
